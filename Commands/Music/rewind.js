...
module.exports = {
    ...
    aliases: ["", ""], // lệnh phụ
    description: "Tua lại trong N giây", // mô tả lệnh
        ...
        let newQueue = client.distube.getQueue(guildId);
				...
				if (!args[0]) {
					return message.reply({ embeds: [new EmbedBuilder()
							...
							.setTitle(`${client.i18n.get(language, "music", "rewind_0")}`)
							.setDescription(`${client.i18n.get(language, "music", "rewind_1", { rewind_prefix: prefix })}`)
						],
					})
				}
				...
				message.reply({ content: `${client.i18n.get(language, "music", "rewind_2", { seekNumber: seekNumber })}` });
      } catch (error) {
        console.log(error);
      };
    } catch(error){
